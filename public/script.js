  ...
  <body>
    <div class="app-root">
      <header class="app-header">
        ...
        <p>
          Build custom, cinematic devil-fruit abilities on the fly for your One Piece–style DnD game.
        </p>
      </header>
      ...
      <main class="app-main">
        ...
        <section class="panel panel-inputs">
          ...
          <div class="card">
            ...
            <label>
              ...
              <textarea
                id="effect-notes"
                rows="2"
                placeholder="e.g. one big finisher, one defensive reaction, one team buff…"
              ></textarea>
            </label>
          </div>

          <!-- Devil Fruit Types (box B, cleaned) -->
          <div class="card">
            <h2>B. Devil Fruit Types</h2>
            <p class="hint">
              Select the <strong>categories</strong> of devil fruits involved in this combo (not specific
              powers like gravity or ice).
            </p>
            <div class="checkbox-grid">
              <label>
            ...
            <label>
              ...
              <textarea
                id="fruit-notes"
                rows="2"
                placeholder="Specific fruits or combos, e.g. Kaido’s dragon + hormone-style body control + ice-themed flavor."
              ></textarea>
            </label>
          </div>
          ...
          <div class="card">
            <h2>C. Desired Outcome / Ability Shape</h2>
            <p class="hint">
              What do you want the combo to <strong>actually do</strong> in the scene? Pick a few, then use the
              notes box to specify an exact outcome.
            </p>
            <div class="checkbox-grid">
              <label>
          ...
          <div class="card">
            ...
            <label>
              ...
              <select id="model-choice">
                <option value="gpt-4.1-mini">
                  Fast & cheap (gpt-4.1-mini) – recommended for most use
                </option>
                <option value="gpt-4.1">
                  Stronger (gpt-4.1) – better quality, higher cost
                </option>
                <option value="gpt-5.1">
                  Max power (gpt-5.1) – requires verified org; may error if not allowed
                </option>
              </select>
            </label>
            ...
            <label>
              ...
              <select id="mechanics-detail">
                <option value="simple">
                  Simple: action type, range, save, damage, and 1–2 core effects
                </option>
            ...
            <label>
              ...
              <textarea
                id="output-notes"
                rows="2"
                placeholder="e.g. one defensive, one offensive, one support; avoid super complex tracking; limit to 5–7 lines per ability."
              ></textarea>
            </label>
          </div>
        </section>
        ...
        <section class="panel panel-output">
          ...
          <div class="card">
            <details class="power-ref">
              <summary>Power Level Reference (1–10)</summary>
              <div class="power-ref-body">
                <p class="hint">
                  How power level influences DC, damage, area, effects, and drawbacks.
                </p>
                <ul class="power-ref-list">
                  <li><strong>1:</strong> DC 4–6. Very weak / trivial. 0–1 die or small effect. Mostly utility or soft flavor.</li>
                  <li><strong>2:</strong> DC 6–7. Very weak but noticeable. 1–2 dice or a light debuff.</li>
                  <li><strong>3:</strong> DC 7–9. Weak but useful. 1–2 dice + minor rider or small control.</li>
                  <li><strong>4:</strong> DC 9–11. Solid low-tier move. 2–3 dice, small area or moderate utility.</li>
                  <li><strong>5:</strong> DC 11–13. Standard PC-level ability. 3–4 dice, decent effect.</li>
                  <li><strong>6:</strong> DC 13–16. Strong PC or elite enemy move. 4–5 dice or strong control.</li>
                  <li><strong>7:</strong> DC 16–20. Boss-tier. 6–8 dice, big impact, clear drawback (HP cost, limited uses, etc.).</li>
                  <li><strong>8:</strong> DC 20–23. Very high. 8–10+ dice or large area with strong conditions; serious drawback.</li>
                  <li><strong>9:</strong> DC 24–28. Mythic-level. Can do 100+ total damage, large area, multiple riders and lasting effects; heavy drawback.</li>
                  <li><strong>10:</strong> DC 26–32. Godlike / reality-warping. Encounter-or arc-defining move with huge damage, massive area, multiple conditions and terrain changes; massive drawback.</li>
                </ul>
              </div>
            </details>
          </div>
